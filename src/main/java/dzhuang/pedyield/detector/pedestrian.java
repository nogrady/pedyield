	...
	public pedestrian(track t){
		...
		if(!t.trajs.isEmpty()) {
			...
			if(this.theFirstFrame_in_aoi!=-1 && this.theLastFrame_in_aoi!=-1 && 
					theFirstFrame_in_aoi_bottom!=-1 && theLastFrame_in_aoi_bottom!=-1 &&
					((theFirstFrame_in_aoi_bottom>pivotal_y && theLastFrame_in_aoi_bottom<=pivotal_y) ||
					 (theFirstFrame_in_aoi_bottom<=pivotal_y && theLastFrame_in_aoi_bottom>pivotal_y))) {
				this.theLastFrame_in_aoi=this.theLastFrame_in_aoi+1<=this.theLastFrame ? this.theLastFrame_in_aoi+1 : this.theLastFrame;
