...
public class detection {
	...
	public void toPosition(Bbox bbox) {
		double xmin=(double)bbox.left;
		double ymin=(double)bbox.top;
		double xmax=(double)bbox.right;
		double ymax=(double)bbox.bottom;
	...
	public detection(int frame, double time, String type, double prob, 
